...
Finds connected referral networks and candidate abuse clusters

Feature Engineering

Builds graph, identity, timing and behavioral signals

ML Risk Scoring

Scores the likelihood of coordinated abuse

Claim Risk Engine

Makes an immediate claim-time decision

Autonomous Observation

Re-evaluates held claims using post-signup behavior

Decision Policy

Converts risk into approve / hold / reject
...
Payment fingerprints, webhooks and payout gating

Audit Log

Records decisions, reasons, policy version and outcomes
...
Resolve a held claim through observation
